  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste management and recycling. Analyze this image and provide:
        ...
        Respond in JSON format like this and only reply as application/json nothing else nothing more
      ...
      const sexytext = text
        ...
        .replace(/json/g, ""); // Remove all occurrences of "json"
      console.log(sexytext);
      
      try {
        const parsedResult = JSON.parse(sexytext);
